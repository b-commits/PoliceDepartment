...
internal static class PoliceDepartmentDbSeeder
{
    internal static void Seed(this ModelBuilder modelBuilder)
    {
        var policeOfficers = new List<PoliceOfficer>
        {
            ...
            new(Guid.NewGuid(), "Rey", "McSriff", new DateOnly(1965, 6, 23), "#-232-767-666"),
            new(Guid.NewGuid(), "Glenallen", "Mixon", new DateOnly(1975, 8, 24), "#-896-921-338"),
            new(Guid.NewGuid(), "Rawl", "Chamgerlain", new DateOnly(1968, 11, 26), "#-766-655-594"),
            new(Guid.NewGuid(), "Kevin", "Nogilny", new DateOnly(1986, 1, 21), "#-778-988-363"),
            new(Guid.NewGuid(), "Tony", "Smherik", new DateOnly(1982, 3, 3), "#-569-450-729"),
